...
class Game:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.open_img = pygame.image.load('E:\\Projects\\Type\\type-speed-open.png')
        self.open_img = pygame.transform.scale(self.open_img, (self.w,self.h))


        self.bg = pygame.image.load('E:\\Projects\\Type\\bg.jpg')
        self.bg = pygame.transform.scale(self.bg, (800,850))
    ...
    def get_sentence(self):
        f = open('E:\\Projects\\Type\\sentences.txt').read()
        sentences = f.split('\n')
    ...
    def show_results(self, screen):
        if(not self.end):
            ...
            # draw icon image
            self.time_img = pygame.image.load('E:\\Projects\\Type\\icon.png')
    ...
    def reset_game(self):
        ...
        msg = "Typing Speed Test by Happy Typing"
        self.draw_text(self.screen, msg,90, 60,self.HEAD_C)  
